...
struct PredefinedItems {
    static let electronics: [Item] = [
    ...
    static let bag: [Item] = [
        Item(name: "Mochila", category: .bag),
        Item(name: "Bolsa", category: .bag),
        Item(name: "Necessaire", category: .bag),
        Item(name: "Sacola", category: .bag),
        Item(name: "Pochete", category: .bag),

    ]
    
    static let miscellaneous: [Item] = [
